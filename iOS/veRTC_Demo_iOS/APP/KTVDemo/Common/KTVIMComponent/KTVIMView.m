...
@interface KTVIMView ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *roomTableView;

@end

@implementation KTVIMView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    KTVIMCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KTVIMCellID" forIndexPath:indexPath];
...
- (UITableView *)roomTableView {
    if (!_roomTableView) {
        ...
        [_roomTableView registerClass:KTVIMCell.class forCellReuseIdentifier:@"KTVIMCellID"];
