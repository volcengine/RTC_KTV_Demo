...
- (UIImageView *)iconImageView {
    if (!_iconImageView) {
        ...
        _iconImageView.image = [UIImage imageNamed:@"KTV_live" bundleName:HomeBundleName];
    }
...
- (UIImageView *)peopleNumImageView {
    if (!_peopleNumImageView) {
        ...
        _peopleNumImageView.image = [UIImage imageNamed:@"KTV_people" bundleName:HomeBundleName];
    }
